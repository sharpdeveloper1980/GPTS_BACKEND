    ...
    public function discover(Request $request) {
		...
		*/
        ...
        foreach($clusters as $row){
          ...
          $item1['cluster_thumb']=(!empty($row->cluster_thumb))?"https://d33umu47ssmut9.cloudfront.net/career/discover/" . $row->cluster_thumb:'';
          $item1['edieo_cluster_thumb']=(!empty($row->edieo_cluster_thumb))?"https://d33umu47ssmut9.cloudfront.net/career/career-video/" . $row->edieo_cluster_thumb:'';
