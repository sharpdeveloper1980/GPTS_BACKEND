    ...
    public function save(Request $request) {
        ...
        try {
            ...
            if ($userId) {
            	...
            	$college->year_of_build = $request->year_of_build;
            	$college->area     		= $request->country;
            	$college->total_rating	= $request->total_rating;
            	$college->total_students= $request->total_students;
            	$college->video_brief   = $request->video_brief;
				$college->degree   		= $request->degree;
                ...
                if ($collegeId) {
                    ...
                    foreach ($request->alumni_desc as $key => $value) :
                        ...
                        $alumni[] = array(
                            ...
                            'designation' 	=> $request->alumni_desi[$key],
                            'company_name' 	=> $request->alumni_company[$key],
                            'created_by' 	=> Auth::user()->id,
                            'created_at' 	=> date('Y-m-d h:i:s'),
                        );
                        //endif;
