    ...
    public function getSingleCareer(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $subcareer = Career::select('id', 'name', 'slug','banner_title','career_icon', 'career_banner')->whereParent($career->id)->whereStatus(1)->get();
                $subcareerlist = array();
                $careerids = array();
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                if ($career != ''):
                    ...
                    $allData['slug'] = $career->slug;
                    $allData['about'] = $career->about;
                    $allData['area_cover'] = array_filter($career->area_cover);
                    ...
                    $allData['competencies'] = $career->competencies;
                    $allData['career_ladder'] = array_filter($career->career_ladder, 'strlen');
