                    ...
                    <div class="tab-pane container active" id="student">
                        <!-- form -->
						  ...
						  <form method="POST" action="{{ route('user-save') }}">
							...
							<div class="form-group">
                                <label class="text-uppercase label-customLogin">Gender</label>
                                
								<select class="form-control removeBorderRadius" name="gender" id="gender">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control removeBorderRadius" id="confirm_password" name="confirm_password" required> 
							</div>
                            <div class="headingTwo"> Contact Information</div>
                            <div class="form-group">
                                <label class="text-uppercase label-customLogin">Address</label>
                                <textarea class="form-control removeBorderRadius" id="address" name="address" ></textarea>
                            ...
                            <div class="form-group"> 
                                ...
                                <select class="form-control removeBorderRadius" id="country" name="country">
									<option value="">Select Country</option>
                                   @foreach($country as $countrykey)
										<option value="{{$countrykey->id}}">{{$countrykey->country_name}}</option>
								   @endforeach 
                                </select>
                            </div>
                            <div class="form-group">
                                <label class="text-uppercase label-customLogin">city</label>
                               <input class="form-control removeBorderRadius" id="city" type="text" name="city" required> 
                            </div>
                            <div class="form-group">
                                <label class="text-uppercase label-customLogin">Resion</label>
                               <input class="form-control removeBorderRadius" id="resion" type="text" name="resion" required> 
                            </div>
                            ...
                            <!-- button -->
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-customSuccess removeBorderRadius text-uppercase">Submit</button>
                            </div>
                        </form>
                    </div>
                    <!-- institutions -->
