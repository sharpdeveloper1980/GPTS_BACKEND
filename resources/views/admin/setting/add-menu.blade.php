...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="row">
			...
			@endif
				{{ Form::open(['url' => '/admin/save-menu', 'method' => 'post','files' => true]) }}
				{{csrf_field()}}
				 <div class="box-body">
					<div class="form-group">
					{{ Form::label('menu', 'Menu') }}<span class="required">*</span>
					{{ Form::text('menu', null, ['placeholder' => 'Menu', 'class' => 'form-control','maxlength' => 100,'required'=>'required']) }}
					</div>
					<div class="form-group">
					...
					{{ Form::text('link', null, ['placeholder' => 'Link', 'class' => 'form-control','maxlength' => 100]) }}
					</div>
					<div class="form-group">
					{{ Form::label('icon', 'Icon') }}<span class="required">*</span>
					{{ Form::text('icon', null, ['placeholder' => 'Icon', 'class' => 'form-control','maxlength' => 100,'required'=>'required']) }}
					</div>
					<div class="form-group">
					{{ Form::label('position', 'Position') }}<span class="required">*</span>
					{{ Form::text('position', null, ['placeholder' => 'Position', 'class' => 'form-control','maxlength' => 100,'required'=>'required']) }}
					</div>
				 </div>
